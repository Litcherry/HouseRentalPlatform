...
public class HouseOrderInfoController {
    ...
    @ResponseBody
    public Result<List<HouseOrderInfoVO>> listAgent(@RequestBody HouseOrderInfoQueryDto houseOrderInfoQueryDto) {
        return houseOrderInfoService.listAgent(houseOrderInfoQueryDto);
    }
