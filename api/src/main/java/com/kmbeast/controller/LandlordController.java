...
public class LandlordController {
    ...
    @ResponseBody
    public Result<String> reject(@PathVariable Integer id, @RequestBody(required = false) Map<String, String> params) {
        return landlordService.rejectApplication(id, params != null ? params.get("reason") : null);
    }
