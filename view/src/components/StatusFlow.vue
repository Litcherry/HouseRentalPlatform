...
export default {
    ...
    data() {
        return {
            statusConfig: {
                0: { text: "申请中", icon: "el-icon-document", color: "#409EFF", status: "process" },
                1: { text: "待看房", icon: "el-icon-time", color: "#E6A23C", status: "process" },
                2: { text: "已完成", icon: "el-icon-circle-check", color: "#67C23A", status: "success" },
                3: { text: "已取消", icon: "el-icon-circle-close", color: "#909399", status: "finish" },
                4: { text: "已爽约", icon: "el-icon-warning", color: "#F56C6C", status: "error" },
                5: { text: "已拒绝", icon: "el-icon-error", color: "#F56C6C", status: "error" }
            }
        }
    },
    computed: {
