...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'agent-house-order-info',
        component: () => import(`@/views/service/AgentHouseOrderInfo.vue`),
      }
    ],
  },
  {
  ...
  },
  {
    ...
    name: 'feedbackSubmit',
    component: () => import(`@/views/user/FeedbackSubmit.vue`)
  },
  {
    path: "/feedback-my",
    name: 'feedbackMy',
    component: () => import(`@/views/user/FeedbackMy.vue`)
  },
  {
    path: "/login",
    name: 'login',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/jump-order-report-manage",
        name: '跳单举报管理',
        show: true,
        icon: 'el-icon-warning-outline',
        component: () => import(`@/views/admin/JumpOrderReportManage.vue`),
        meta: { requireAuth: true },
      },
      {
