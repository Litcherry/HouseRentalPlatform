                    ...
                    <el-dropdown trigger="click">
                        <span class="user-dropdown-trigger">
                            <div class="user-info">
                                ...
                                <span style="margin-left: 10px; font-size: 12px; color: #67C23A;" v-if="userInfo.creditScore !== undefined">
                                    <i class="el-icon-medal"></i> {{ userInfo.creditScore }}分
                                </span>
                                <i style="color: rgb(51,51,51);" class="el-icon-arrow-down dropdown-icon"></i>
                            </div>
                        </span>
                        <el-dropdown-menu slot="dropdown" class="user-dropdown">
                            <el-dropdown-item v-if="userInfo.role === 1 || userInfo.role === 3 || (landlord !== null && landlord.isAudit)" @click.native="serviceCenter"
                                icon="el-icon-menu">
                                服务中心
                            </el-dropdown-item>
