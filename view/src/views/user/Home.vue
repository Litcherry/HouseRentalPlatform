                ...
                <div class="house-list">
                    ...
                    <div @click="houseItemClick(item.id)" class="house-item" v-for="item in houseList" :key="item.id">
                        ...
                        <div>
                            <div class="name">
                                {{ item.name }}
                                <el-tag size="mini" effect="dark" type="success" v-if="!item.agentId"
                                    style="margin-left: 5px;">房东直租</el-tag>
                                <el-tag size="mini" effect="dark" type="primary" v-else
                                    style="margin-left: 5px;">中介托管</el-tag>
                            </div>
                            <div class="point">
                                <div>
                                    <i class="el-icon-location"></i>
            ...
            <div class="right">
                ...
                <div class="feedback-card">
                    <h3 style="margin-top: 0; margin-bottom: 15px; color: #333;">
                        <i class="el-icon-chat-line-square" style="margin-right: 8px;"></i>问题反馈
                    </h3>
                    <div class="feedback-content">
                        <p style="font-size: 14px; color: #666; margin-bottom: 15px;">
                            遇到问题或有建议？点击下方按钮向我们反馈
                        </p>
                        <el-button type="primary" size="small" @click="goToFeedback" style="width: 100%;">
                            <i class="el-icon-edit-outline"></i> 提交反馈
                        </el-button>
                        <el-button type="text" size="small" @click="goToMyFeedback" style="width: 100%; margin-top: 8px;">
                            <i class="el-icon-view"></i> 我的反馈
                        </el-button>
                    </div>
                </div>

                <h2 style="margin-top: 20px;">房源推荐</h2>
