            ...
            <div class="house-grid">
                <div class="house-card" @click="houseView(house)" v-for="(house, i) in featuredHouses" :key="i">
                    ...
                    <div class="card-details">
                        <h3>
                            {{ house.name }}
                            <el-tag size="mini" effect="dark" type="success" v-if="!house.agentId"
                                style="margin-left: 5px; float: right;">房东直租</el-tag>
                            <el-tag size="mini" effect="dark" type="primary" v-else
                                style="margin-left: 5px; float: right;">中介托管</el-tag>
                        </h3>
                        <p class="location">
