                ...
                <div>
                    ...
                    <div style="margin-top: 20px;display: flex;gap: 10px;">
                        <div>
                            ...
                            <el-tag size="mini" v-else-if="houseOrderInfo.orderStatus === 4" type="danger">状态:已爽约</el-tag>
                            <el-tag size="mini" v-else-if="houseOrderInfo.orderStatus === 5" type="danger">状态:已拒绝</el-tag>
                        </div>
                        <div>
...
import { getRole } from "@/utils/storage.js";
export default {
    ...
    methods: {
        ...
        async handleConfirmOk() {
            try {
                ...
                if (this.inputWriteOffCode !== this.houseOrderInfo.writeOffCode) {
                    this.$message.error("核销码错误，请重新核对");
                    return;
                }
        ...
        async fetchFreshData() {
            try {
                let url = '/house-order-info/listLandlord';
                const role = getRole();
                if (Number(role) === 3) {
                    url = '/house-order-info/listAgent';
                }
